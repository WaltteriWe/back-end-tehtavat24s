...
INSERT INTO SavedItems (user_id, media_id) VALUES
(1, 1),
(2, 2),
(3, 1),
(1, 3);
...
VALUES ('NewUser', 'password-hashed', 'newuser@example.com', 2);

INSERT INTO MediaItems (user_id, filename, filesize, media_type, title, description) 
VALUES (1, 'new_image.jpg', 1024, 'image/jpeg', 'New Image', 'Description of new image');

-- READ
SELECT * FROM Users WHERE user_id = 1;

SELECT title, description FROM MediaItems WHERE media_id = 9632;
